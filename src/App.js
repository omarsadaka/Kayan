...
import { StyleSheet, Dimensions,
  ScrollView,AsyncStorage, SafeAreaView,
    ...
    if (state.isConnected){
      try {
        axios.get('http://134.209.178.237/api/user/getUserByID',{
          ...
          this.setState({userType:this.state.userData.type})
          ...
          <TouchableOpacity  onPress={() => this.props.navigation.navigate('Notification')}>
            ...
            {!this.state.userName ?
             ...
             <Text
              ...
              style={[styles.shadow,{
                width:50,textAlign: 'center', color: '#343434',backgroundColor:'#F8F8F8',margin:7,fontSize: 16,borderRadius:5,padding:5}]}>AR</Text>
          </View>
                 {this.state.flag_skip == 0 ? 
                  <View>
                  <TouchableOpacity 
                  onPress={() => this.props.navigation.navigate('MyProfileScreen')}
                  style={{height:height*0.06,flexDirection:'row',marginTop:3 ,alignItems:'center',marginStart:'8%' , }}>
                    <Image source={require('../img/profile.png')} 
                    style={{height:30,width:30}}
                    resizeMode='stretch'
                    ></Image>
                    <Text style={{paddingEnd:0,color:'#343434',fontSize:18 ,fontFamily:"segoe",marginStart: 15,  }}>
                    My Profile
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                ...
                <Image source={require('../img/mycar.png')}
                  ...
                  resizeMode='stretch'
                ></Image>
                <Text style={{ paddingEnd: 0, color: '#343434', fontSize: 18, marginStart: 15, fontFamily:"segoe"   }}>
                  My cars
                  </Text>
              </TouchableOpacity>
               ...
               <TouchableOpacity
                ...
                Payable bills
                  ...
                  style={{height:height*0.06,flexDirection:'row',marginTop:3 ,alignItems:'center',marginStart:'8%' , marginBottom:20}}>
